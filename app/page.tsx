  ...
  return (
    <div style={{ background: "#fff", minHeight: "100vh" }}>
      ...
      <style jsx>{`
        ...
        .hero-pill { display: inline-flex; align-items: center; gap: 7px; background: #F6F6F6; color: #2C645B; font-size: 12px; font-weight: 800; padding: 8px 11px; border-radius: 999px; }
        ...
        .hero-visual { position: relative; } .visual-window { border: 1px solid #dce4de; border-radius: 20px; overflow: hidden; box-shadow: 0 35px 70px rgb(24 61 39 / 15%); transform: rotate(1deg); }
        ...
        .scan-preview { position: relative; min-height: 350px; background: #eff2ef; border-radius: 14px; display: grid; place-items: center; overflow: hidden; }
        .bottle { width: 115px; height: 240px; border-radius: 32px 32px 18px 18px; background: linear-gradient(145deg,#fdfefe,#dae9df); box-shadow: 0 18px 30px #bcc9c0; display: flex; flex-direction: column; align-items: center; padding-top: 48px; color: #1e5171; transform: rotate(-4deg); } .bottle span { font-size: 16px; font-weight: 900; }.bottle b { font-size: 23px; line-height: .9; text-align: center; margin: 26px 0 12px; color: #18455f; }.bottle small { font-size: 8px; font-weight: 800; letter-spacing: .15em; }
        .scan-corners { position: absolute; inset: 30px; border: 2px solid #73AB95; border-radius: 12px; opacity: .65; }
        ...
        .result-panel label { display:block;font-size:8px;font-weight:800;color:#6f7b73;margin:12px 0 5px}.fake-input{border:1px solid #e1e6e2;border-radius:7px;padding:9px;font-size:9px}.fake-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}.result-panel button{margin-top:22px;width:100%;border:0;border-radius:8px;background:#2C645B;color:white;padding:11px;font-size:9px;font-weight:800;display:flex;align-items:center;justify-content:center;gap:6px}
        .float-card { position:absolute;display:flex;gap:10px;align-items:center;background:white;border:1px solid #e1e7e2;border-radius:12px;padding:11px 14px;box-shadow:0 12px 30px rgb(30 55 39 / 12%)}.float-card>div{width:32px;height:32px;border-radius:9px;background:#F6F6F6;color:#2C645B;display:grid;place-items:center}.float-card b,.float-card small{display:block}.float-card b{font-size:10px}.float-card small{font-size:8px;color:#7b857e;margin-top:3px}.float-one{left:-28px;top:50px}.float-two{right:-15px;bottom:42px}
