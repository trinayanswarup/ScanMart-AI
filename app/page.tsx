...
import { ArrowRight, Box, CheckCircle2, Coffee, Eye, Moon, ScanLine, Scissors, ShoppingBag, Store, Sparkles, Sun, Github } from "lucide-react";
    ...
    <div style={{ minHeight: "100vh", background: "var(--canvas)", overflowX: "hidden" }}>
      ...
      <nav style={{ padding: "0 40px", height: 80, display: "flex", alignItems: "center", justifyContent: "space-between", position: "absolute", top: 0, left: 0, right: 0, zIndex: 50 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ width: 28, height: 28, background: "var(--brand)", display: "grid", placeItems: "center", transform: "rotate(45deg)" }}>
        ...
        <div style={{ display: "flex", gap: 24, alignItems: "center" }}>
          ...
          <button
            ...
            style={{ background: "transparent", border: "1px solid var(--line)", borderRadius: 6, width: 36, height: 36, display: "grid", placeItems: "center", cursor: "pointer", color: "var(--muted)", transition: "all 0.2s", flexShrink: 0 }}
          >
      ...
      <section style={{ paddingTop: 160, paddingBottom: 120, paddingLeft: "max(40px, calc((100vw - 1200px) / 2))", paddingRight: 0, display: "flex", alignItems: "center", gap: 60, minHeight: "90vh" }}>
        ...
        <div style={{ flex: "0 0 500px", zIndex: 10 }}>
          ...
          <div style={{ display: "flex", gap: 20, alignItems: "center" }}>
            ...
            <Link href="/admin" style={{ fontSize: 14, fontWeight: 600, color: "var(--ink)", display: "flex", alignItems: "center", gap: 8, borderBottom: "1px solid var(--line)", paddingBottom: 4, transition: "border-color 0.2s" }} className="hover:border-[var(--brand)]">
        ...
        <div className="animate-fade-in delay-200" style={{ flex: 1, position: "relative", height: 600 }}>
          <div style={{ position: "absolute", top: 0, left: 0, right: -100, bottom: 0, background: "var(--surface)", border: "1px solid var(--line)", borderRight: "none", boxShadow: "-20px 40px 80px rgba(4, 26, 21, 0.08)", display: "flex", flexDirection: "column" }}>

            {/* Header / Chrome */}
            <div style={{ height: 50, borderBottom: "1px solid var(--line)", display: "flex", alignItems: "center", padding: "0 24px", gap: 16 }}>
            ...
            <div style={{ flex: 1, display: "flex", padding: 32, gap: 40 }}>
              ...
              <div style={{ width: 140, display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div style={{ height: 1, width: "80%", background: "var(--line)" }} />
              ...
              <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 32 }}>
                ...
                {/* Typographic Metrics */}
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24, borderBottom: "1px solid var(--line)", paddingBottom: 32 }}>
                  <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  {["Lavender Shampoo", "Cold Brew 250ml", "Organic Honey"].map((name, i) => (
                    <div key={name} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid var(--line)", paddingBottom: 16 }}>
      ...
      {/* ─── Our Brands ─── */}
      <section style={{ padding: "120px 40px", background: "var(--surface)", borderTop: "1px solid var(--line)" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 24 }}>
            ...
            <div style={{ gridColumn: "1 / -1", background: "var(--brand-soft)", padding: "48px 40px", display: "flex", alignItems: "center", gap: 32, flexWrap: "wrap" }}>
              <div style={{ width: 80, height: 80, background: "var(--surface)", borderRadius: 16, display: "grid", placeItems: "center", flexShrink: 0, border: "1px solid var(--line)", boxShadow: "0 10px 30px rgba(4,26,21,0.05)" }}>
            ...
            {/* Corner Café (Surface Card) */}
            <div style={{ background: "var(--surface)", border: "1px solid var(--line)", padding: 40, display: "flex", flexDirection: "column" }}>
            ...
            {/* Urban Glow (Always-Dark Card) */}
            <div style={{ background: "#041A15", padding: 40, display: "flex", flexDirection: "column" }}>
      ...
      <section style={{ padding: "120px 40px", background: "var(--canvas)", borderTop: "1px solid var(--line)" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 80 }}>
            {[
              ...
              <div key={step.num} style={{ display: "flex", gap: "10%", alignItems: "flex-start", borderTop: "1px solid var(--line)", paddingTop: 40 }}>
                {/* Large Ghost Number */}
                <div style={{ fontSize: "clamp(80px, 10vw, 140px)", fontWeight: 300, color: "var(--ghost-num)", lineHeight: 0.8, letterSpacing: "-.06em", flexShrink: 0 }}>
                  {step.num}
                </div>
                {/* Content */}
      ...
      {/* ─── Bottom CTA ─── */}
      <section style={{ padding: "120px 40px", background: "#041A15", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ color: "var(--sage)", fontSize: 18, margin: "0 auto 60px", fontWeight: 400, maxWidth: 400, lineHeight: 1.6 }}>
            Explore our brands and discover what's in store today.
          </p>
          <div style={{ display: "flex", gap: 24, justifyContent: "center", alignItems: "center" }}>
            <Link href="/shop" className="btn" style={{ background: "white", color: "#041A15", minHeight: 56, fontSize: 14, padding: "0 40px", borderRadius: 0, fontWeight: 700 }}>
              Browse our stores
            </Link>
      ...
      {/* ─── Footer ─── */}
      <footer style={{ padding: "40px", background: "#041A15", borderTop: "1px solid rgba(255,255,255,0.08)", display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 12, color: "var(--sage)", fontWeight: 500, flexWrap: "wrap", gap: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
          ...
          <a href="https://github.com/trinayanswarup" target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 6, color: "var(--sage)", transition: "color 0.2s" }} className="hover:text-white">
